  ...
  return (
    <section className="mt-8 w-full max-w-2xl rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-lg font-semibold text-neutral-900">Tidy up</h2>
        ...
        <div className="mt-4">
          {state.proposals.length === 0 ? (
            ...
            <>
              ...
              <ul className="mt-2 max-h-80 divide-y divide-neutral-100 overflow-y-auto rounded-lg border border-neutral-200">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                ...
                <select
                  ...
                  className="rounded-lg border border-neutral-300 bg-white px-2 py-1 text-xs text-neutral-800 focus:border-indigo-500 focus:outline-none disabled:bg-neutral-100"
                >
                ...
                <input
                  ...
                  maxLength={100}
                  className="min-w-0 flex-1 rounded-lg border border-neutral-300 bg-white px-2 py-1 text-xs text-neutral-800 placeholder:text-neutral-400 focus:border-indigo-500 focus:outline-none"
                />
              </div>
